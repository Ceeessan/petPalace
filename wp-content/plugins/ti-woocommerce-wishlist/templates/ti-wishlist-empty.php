...
<div class="tinv-wishlist woocommerce tinv-wishlist-clear">
	...
	<p class="return-to-shop">
		<a class="button wc-backward"
		   href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>"><?php echo esc_html( apply_filters( 'woocommerce_return_to_shop_text', __( 'Gå tillbaka till butiken', 'ti-woocommerce-wishlist' ) ) ); ?></a>
	</p>
</div>
