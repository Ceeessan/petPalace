...
function display_icons_filter(){
    ...
    <div class="icon-div"> 
        <img class="icon-animals dog-icon" data-category="hund" src="'. get_template_directory_uri() . '/resources/images/dog-icon.png"> 
        <p class="icon-text">Hund</p> 
    </div>

    <div class="icon-div"> 
        <img class="icon-animals cat-icon" data-category="katt" src="'. get_template_directory_uri() . '/resources/images/cat-icon.png"> 
        <p class="icon-text">Katt</p>  
    </div>

    <div class="icon-div"> 
        <img class="icon-animals rabbit-icon" data-category="gnagare" src="'. get_template_directory_uri() . '/resources/images/rabbit-icon.png"> 
        <p class="icon-text">Gnagare</p> 
    </div>
    
    <div class="icon-div"> 
        <img class="icon-animals bird-icon" data-category="faglar" src="'. get_template_directory_uri() . '/resources/images/bird-icon.png">
